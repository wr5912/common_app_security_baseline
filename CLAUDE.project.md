...
- 必读文档：`README.md`、`00_总览/终端应用安全基线画像库 AI 维护规范.md`、`00_总览/终端应用安全基线画像库总览.md`、`00_总览/维护工作流.md`、对应类型模板（`99_模板/*`）、相关实体页面、`logs/变更日志.md`。
...
- 兼容边界：可调整 Markdown 模板与 `tools/` 抽取脚本；改动 frontmatter 字段、`type` 枚举、目录结构或 API 输出契约时，必须同步 `README.md`、`00_总览/终端应用安全基线画像库 AI 维护规范.md`、`11_抽取与图谱/` 抽取规范和样例数据。
