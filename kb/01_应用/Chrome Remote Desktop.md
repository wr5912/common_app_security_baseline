...
type: app
os: windows
app_id: app_chrome_remote_desktop
app_name_cn: "Chrome 远程桌面"
app_name_en: "Chrome Remote Desktop"
vendor: "Google LLC"
category: "远控 / 运维"
subcategory: "远程桌面"
...
Chrome Remote Desktop 属于 `远控 / 运维` 场景应用。当前画像依据 `/tmp/windows系统上常见应用.md` 中的常见服务基线清单建立，用于终端服务、进程和资产角色识别；具体路径、签名和版本差异需要结合企业终端观测确认。
...
```text
未授权资产出现 remoting_host.exe 常驻
远控主机配置变更后立即出现异常登录或数据访问
```
