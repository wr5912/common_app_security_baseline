...
type: app
os: windows
app_id: app_teamviewer
app_name_cn: "TeamViewer"
app_name_en: "TeamViewer"
...
TeamViewer 属于 `远控 / 运维` 场景应用。当前画像依据 `/tmp/windows系统上常见应用.md` 中的常见服务基线清单建立，用于终端服务、进程和资产角色识别；具体路径、签名和版本差异需要结合企业终端观测确认。
...
授权运维场景下提供远程控制和无人值守访问。

## 11. 异常关注点

```text
未授权资产出现 TeamViewer 服务
安装后短时间外联并伴随异常登录
服务从临时目录运行或签名异常
```
