...
os: windows
source_id: src_windows-service-control-manager_profile_evidence
title: "Windows Service Control Manager 画像证据记录"
...
# Windows Service Control Manager 画像证据记录

<!-- generated: windows-complete-profile-backfill -->

## 1. 来源说明

本页用于记录 [[Windows Service Control Manager]] 在完整画像补齐中的证据边界。当前画像来源包括：
