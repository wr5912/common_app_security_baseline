...
os: windows
source_id: src_windows-powershell_profile_evidence
title: "Windows PowerShell 画像证据记录"
...
# Windows PowerShell 画像证据记录

<!-- generated: windows-complete-profile-backfill -->

## 1. 来源说明

本页用于记录 [[Windows PowerShell]] 在完整画像补齐中的证据边界。当前画像来源包括：
