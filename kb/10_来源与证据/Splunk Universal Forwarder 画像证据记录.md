...
os: windows
source_id: src_splunk-universal-forwarder_profile_evidence
title: "Splunk Universal Forwarder 画像证据记录"
...
本页用于记录 [[Splunk Universal Forwarder]] 在完整画像补齐中的证据边界。当前画像来源包括：
