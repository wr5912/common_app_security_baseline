...
type: service
os: windows
service_name: "VeeamTransportSvc"
display_name: "Veeam Transport"
app: "[[Veeam Transport]]"
vendor: "Veeam Transport"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "VeeamTransportSvc.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-074
tags:
...
来源行 `third-party-service-074`（第 477 行）记录了 `VeeamTransportSvc`，说明为：备份传输。
