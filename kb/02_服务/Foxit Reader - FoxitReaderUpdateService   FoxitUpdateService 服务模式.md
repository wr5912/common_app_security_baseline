...
type: service
os: windows
service_name: "FoxitReaderUpdateService / FoxitUpdateService"
display_name: "Foxit Reader"
app: "[[Foxit Reader]]"
vendor: "Foxit Reader"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "FoxitReaderUpdateService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-office-009`（第 319 行）记录了 `FoxitReaderUpdateService / FoxitUpdateService`，说明为：PDF 更新。
