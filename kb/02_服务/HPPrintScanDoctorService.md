...
type: service
os: windows
service_name: "HPPrintScanDoctorService"
display_name: "HP Print and Scan Doctor"
app: "[[HP Print and Scan Doctor]]"
vendor: "HP Print and Scan Doctor"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "HPPrintScanDoctorService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-098
tags:
...
来源行 `third-party-service-098`（第 506 行）记录了 `HPPrintScanDoctorService`，说明为：HP 打印。
