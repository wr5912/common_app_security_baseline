...
type: service
os: windows
service_name: "VeeamEndpointBackupSvc"
display_name: "Veeam Agent"
app: "[[Veeam Agent]]"
vendor: "Veeam Agent"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "VeeamEndpointBackupSvc.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-073
tags:
...
来源行 `third-party-service-073`（第 476 行）记录了 `VeeamEndpointBackupSvc`，说明为：备份。
