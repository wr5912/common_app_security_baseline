...
type: service
os: windows
service_name: "CredentialEnrollmentManagerUserSvc"
display_name: "Credential Enrollment Manager"
...
来源行 `win-per-user-009`（第 263 行）记录了 `CredentialEnrollmentManagerUserSvc`，说明为：Credential Enrollment Manager。
