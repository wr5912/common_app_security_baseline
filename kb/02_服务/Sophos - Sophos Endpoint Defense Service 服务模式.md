...
type: service
os: windows
service_name: "Sophos Endpoint Defense Service"
display_name: "Sophos"
app: "[[Sophos]]"
vendor: "Sophos"
...
image_name: "SophosEndpointDefenseService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-edr-014`（第 449 行）记录了 `Sophos Endpoint Defense Service`，说明为：EDR。
