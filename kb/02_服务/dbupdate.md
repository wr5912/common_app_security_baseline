...
type: service
os: windows
service_name: "dbupdate"
display_name: "Dropbox Update Service"
app: "[[Dropbox Update Service]]"
vendor: "Dropbox Update Service"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "dbupdate.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-016`（第 328 行）记录了 `dbupdate`，说明为：Dropbox 更新。

## 2. 所属应用

- [[Dropbox Update Service]]
...
- [[Windows 服务文件与数据画像]]
- [[Dropbox Update Service 文件与数据画像]]

## 8. 常见网络行为

- [[Windows 服务网络行为]]
- [[Dropbox Update Service 网络行为]]
