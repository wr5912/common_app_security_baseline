...
type: service
os: windows
service_name: "NvTelemetryContainer"
display_name: "NVIDIA Telemetry，旧版常见"
app: "[[NVIDIA Telemetry]]"
vendor: "NVIDIA Telemetry"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "NvTelemetryContainer.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-086
tags:
...
来源行 `third-party-service-086`（第 494 行）记录了 `NvTelemetryContainer`，说明为：遥测。
