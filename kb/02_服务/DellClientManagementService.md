...
display_name: "Dell Client Management"
app: "[[Dell Client Management]]"
vendor: "Dell Client Management"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "DellClientManagementService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-092
tags:
...
来源行 `third-party-service-092`（第 500 行）记录了 `DellClientManagementService`，说明为：Dell。
