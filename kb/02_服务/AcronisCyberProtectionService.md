...
type: service
os: windows
service_name: "AcronisCyberProtectionService"
display_name: "Acronis Cyber Protect"
app: "[[Acronis Cyber Protect]]"
...
image_name: "AcronisCyberProtectionService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-076`（第 479 行）记录了 `AcronisCyberProtectionService`，说明为：备份 / 安全。
