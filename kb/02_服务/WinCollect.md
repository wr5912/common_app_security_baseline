...
type: service
os: windows
service_name: "WinCollect"
display_name: "IBM QRadar WinCollect"
app: "[[IBM QRadar WinCollect]]"
vendor: "IBM QRadar WinCollect"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "WinCollect.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-edr-027`（第 462 行）记录了 `WinCollect`，说明为：日志采集。
