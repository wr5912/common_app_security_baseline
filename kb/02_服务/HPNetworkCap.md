...
type: service
os: windows
service_name: "HPNetworkCap"
display_name: "HP Network HSA Service"
app: "[[HP Network HSA Service]]"
vendor: "HP Network HSA Service"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "HPNetworkCap.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-097
tags:
...
来源行 `third-party-service-097`（第 505 行）记录了 `HPNetworkCap`，说明为：HP。
