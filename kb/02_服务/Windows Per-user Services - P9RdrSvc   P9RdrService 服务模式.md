...
type: service
os: windows
service_name: "P9RdrSvc / P9RdrService"
display_name: "Plan 9 Redirector Service / WSL 相关"
...
来源行 `win-per-user-016`（第 270 行）记录了 `P9RdrSvc / P9RdrService`，说明为：Plan 9 Redirector Service / WSL 相关。
