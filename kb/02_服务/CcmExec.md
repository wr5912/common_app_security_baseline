...
display_name: "Microsoft Configuration Manager Client"
app: "[[Microsoft Configuration Manager Client]]"
...
来源行 `third-party-service-078`（第 481 行）记录了 `CcmExec`，说明为：SCCM 客户端。
