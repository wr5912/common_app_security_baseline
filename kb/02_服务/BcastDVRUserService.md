...
type: service
os: windows
service_name: "BcastDVRUserService"
display_name: "Game DVR and Broadcast User Service"
...
来源行 `win-per-user-013`（第 267 行）记录了 `BcastDVRUserService`，说明为：Game DVR and Broadcast User Service。
