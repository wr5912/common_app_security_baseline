...
type: service
os: windows
service_name: "ScreenConnect Client*"
display_name: "ConnectWise Control"
app: "[[ConnectWise Control]]"
vendor: "ConnectWise Control"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "ScreenConnectClient.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-rmm-007`（第 349 行）记录了 `ScreenConnect Client*`，说明为：RMM / 远控。
