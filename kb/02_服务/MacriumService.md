...
type: service
os: windows
service_name: "MacriumService"
display_name: "Macrium Reflect"
app: "[[Macrium Reflect]]"
vendor: "Macrium Reflect"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "MacriumService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-077
tags:
...
来源行 `third-party-service-077`（第 480 行）记录了 `MacriumService`，说明为：备份。
