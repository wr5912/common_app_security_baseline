...
type: service
os: windows
service_name: "DeviceAssociationBroker"
display_name: "Device Association Broker"
...
来源行 `win-per-user-010`（第 264 行）记录了 `DeviceAssociationBroker`，说明为：Device Association Broker。
