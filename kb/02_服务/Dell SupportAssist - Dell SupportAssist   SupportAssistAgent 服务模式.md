...
type: service
os: windows
service_name: "Dell SupportAssist / SupportAssistAgent"
display_name: "Dell SupportAssist"
app: "[[Dell SupportAssist]]"
vendor: "Dell SupportAssist"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "DellSupportAssist.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-093`（第 501 行）记录了 `Dell SupportAssist / SupportAssistAgent`，说明为：Dell 维护。
