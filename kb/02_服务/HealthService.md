...
display_name: "SCOM / Microsoft Monitoring Agent"
app: "[[SCOM / Microsoft Monitoring Agent]]"
vendor: "SCOM / Microsoft Monitoring Agent"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "HealthService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-080`（第 483 行）记录了 `HealthService`，说明为：监控。
