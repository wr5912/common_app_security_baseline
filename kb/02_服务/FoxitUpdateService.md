...
type: service
os: windows
service_name: "Foxit Update Service"
display_name: "FoxitUpdateService"
app: "[[Foxit Reader]]"
vendor: "Foxit"
...
`Foxit Update Service` 是 `Foxit Reader` 相关的常见 Windows 服务名或服务名模式。第三方服务名可能随版本、安装方式和企业定制包变化，应结合路径、签名、启动账户和资产授权共同识别。
