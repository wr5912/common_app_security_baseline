...
type: service
os: windows
service_name: "VirtualBox System Service"
display_name: "VBoxSDS"
app: "[[VirtualBox]]"
vendor: "Oracle"
service_type: Win32OwnProcess
start_type: unknown
start_account: LocalSystem
image_name: "VBoxSDS.exe"
risk_level: medium
confidence: medium
status: active
tags:
...
`VirtualBox System Service` 是 `VirtualBox` 相关的常见 Windows 服务名或服务名模式。第三方服务名可能随版本、安装方式和企业定制包变化，应结合路径、签名、启动账户和资产授权共同识别。
...
- 来源行：`third-party-service-037`，第 390 行
- 所属应用：[[VirtualBox]]
- 进程：[[VBoxSDS.exe]]
- 父子关系：[[services.exe -> VBoxSDS.exe]]
- 注册表：[[Windows 服务注册表画像]]
