...
type: service
os: windows
service_name: "CloudBackupRestoreSvc"
display_name: "Cloud Backup and Restore Service"
...
来源行 `win-per-user-005`（第 259 行）记录了 `CloudBackupRestoreSvc`，说明为：Cloud Backup and Restore Service。
