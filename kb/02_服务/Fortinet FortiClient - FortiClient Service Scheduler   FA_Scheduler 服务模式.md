...
type: service
os: windows
service_name: "FortiClient Service Scheduler / FA_Scheduler"
display_name: "Fortinet FortiClient"
app: "[[Fortinet FortiClient]]"
...
image_name: "FortiClientServiceScheduler.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-vpn-010`（第 369 行）记录了 `FortiClient Service Scheduler / FA_Scheduler`，说明为：企业 VPN / 安全。
