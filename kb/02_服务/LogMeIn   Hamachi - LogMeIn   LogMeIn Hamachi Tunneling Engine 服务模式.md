...
type: service
os: windows
service_name: "LogMeIn / LogMeIn Hamachi Tunneling Engine"
display_name: "LogMeIn / Hamachi"
app: "[[LogMeIn / Hamachi]]"
vendor: "LogMeIn / Hamachi"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "LogMeIn.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-rmm-008`（第 350 行）记录了 `LogMeIn / LogMeIn Hamachi Tunneling Engine`，说明为：远控 / 虚拟网络。
