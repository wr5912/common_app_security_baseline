...
type: service
os: windows
service_name: "OneSyncSvc*"
display_name: "Windows Mail/Calendar/People 同步"
app: "[[Windows Mail/Calendar/People 同步]]"
vendor: "Windows Mail/Calendar/People 同步"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "OneSyncSvc.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-office-005`（第 315 行）记录了 `OneSyncSvc*`，说明为：用户级服务。
