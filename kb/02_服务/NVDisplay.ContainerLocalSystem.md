...
app: "[[NVIDIA Display Container LS]]"
vendor: "NVIDIA Display Container LS"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "NVDisplay.ContainerLocalSystem.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-084
tags:
...
来源行 `third-party-service-084`（第 492 行）记录了 `NVDisplay.ContainerLocalSystem`，说明为：NVIDIA 显卡。
