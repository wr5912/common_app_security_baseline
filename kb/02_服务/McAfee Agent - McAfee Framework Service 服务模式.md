...
type: service
os: windows
service_name: "McAfee Framework Service"
display_name: "McAfee Agent"
app: "[[McAfee Agent]]"
vendor: "McAfee Agent"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "McAfeeFrameworkService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-edr-019`（第 454 行）记录了 `McAfee Framework Service`，说明为：管理代理。
