...
type: service
os: windows
service_name: "webthreatdefusersvc"
display_name: "Web Threat Defense User Service"
...
来源行 `win-per-user-023`（第 277 行）记录了 `webthreatdefusersvc`，说明为：Web Threat Defense User Service。
