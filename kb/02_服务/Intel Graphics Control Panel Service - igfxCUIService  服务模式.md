...
type: service
os: windows
service_name: "igfxCUIService*"
display_name: "Intel Graphics Control Panel Service"
app: "[[Intel Graphics Control Panel Service]]"
vendor: "Intel Graphics Control Panel Service"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "igfxCUIService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-091`（第 499 行）记录了 `igfxCUIService*`，说明为：Intel 显卡。
