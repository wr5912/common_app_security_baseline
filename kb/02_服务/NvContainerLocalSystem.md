...
display_name: "NVIDIA Container"
app: "[[NVIDIA Container]]"
vendor: "NVIDIA Container"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "NvContainerLocalSystem.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-085
tags:
...
来源行 `third-party-service-085`（第 493 行）记录了 `NvContainerLocalSystem`，说明为：NVIDIA。
