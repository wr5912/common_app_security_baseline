...
type: service
os: windows
service_name: "GoogleUpdaterService*"
...
image_name: "GoogleUpdaterService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-006`（第 295 行）记录了 `GoogleUpdaterService*`，说明为：GoogleUpdaterService.exe。
