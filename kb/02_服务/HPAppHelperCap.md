...
type: service
os: windows
service_name: "HPAppHelperCap"
display_name: "HP App Helper"
app: "[[HP App Helper]]"
vendor: "HP App Helper"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "HPAppHelperCap.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-096
tags:
...
来源行 `third-party-service-096`（第 504 行）记录了 `HPAppHelperCap`，说明为：HP。
