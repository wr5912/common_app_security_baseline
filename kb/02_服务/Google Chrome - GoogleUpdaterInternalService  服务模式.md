...
来源行 `third-party-service-007`（第 296 行）记录了 `GoogleUpdaterInternalService*`，说明为：GoogleUpdater.exe / GoogleUpdaterService.exe。
