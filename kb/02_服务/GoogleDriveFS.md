...
type: service
os: windows
service_name: "GoogleDriveFS"
display_name: "Google Drive for desktop"
app: "[[Google Drive for desktop]]"
vendor: "Google Drive for desktop"
service_type: windows_service
start_type: auto_or_manual
start_account: LocalSystem_or_service_account
image_name: "GoogleDriveFS.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
  - third-party-service-018
tags:
...
来源行 `third-party-service-018`（第 330 行）记录了 `GoogleDriveFS`，说明为：Google Drive 文件流。
