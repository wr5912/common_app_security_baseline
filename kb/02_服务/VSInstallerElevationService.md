...
app: "[[Visual Studio Installer Elevation Service]]"
...
image_name: "VSInstallerElevationService.exe"
risk_level: medium
confidence: medium
status: active
source_row_ids:
...
来源行 `third-party-service-041`（第 394 行）记录了 `VSInstallerElevationService`，说明为：VS 安装提权。
