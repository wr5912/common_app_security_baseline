...
type: service
os: windows
service_name: "cyserver / CyveraService"
display_name: "Palo Alto Cortex XDR，部分版本"
...
来源行 `third-party-edr-009`（第 444 行）记录了 `cyserver / CyveraService`，说明为：EDR。
