...
type: process
os: windows
process_name: "VSStandardCollectorService150.exe"
...
## 1. 进程说明
本进程用于承载 [[Visual Studio Standard Collector]] 在 Windows 服务或用户交互场景中的业务逻辑。若来源仅提供服务名而未给出精确 ImagePath，实际二进制路径必须以后续终端观测为准。
