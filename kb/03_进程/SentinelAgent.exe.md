...
type: process
os: windows
process_name: "SentinelAgent.exe"
app: "[[SentinelOne]]"
vendor: "SentinelOne"
role:
  - "SentinelOne Agent 服务进程"
risk_level: medium
confidence: low
status: needs_review
tags:
...
`SentinelAgent.exe` 是 [[SentinelOne]] 相关进程，常见角色为：SentinelOne Agent 服务进程。当前画像用于终端基线识别，具体路径、签名和命令行参数需要结合真实观测校验。
